...
const Cart = () => {
  ...
  return (
    <div>
      ...
      <div className='min-h-[83.75vh] max-w-4xl p-5 mx-auto flex flex-col gap-2 mt-2'>
      <Breadcrumbs container='cart' />
      <main className="flex-grow">
        <div className="h-[300px] border border-gray-300 p-8 w-full max-w-4xl mx-auto bg-white rounded-md mt-10">
        ...
        <div className="border border-gray-300 p-6 w-full max-w-4xl mx-auto bg-white rounded-md mt-5">
          <h2
